...
class _SettingsScreenState extends State<SettingsScreen> {
  // MQTT
  final _mqttHostController = TextEditingController(text: 'mqtt.kabel.io');
    ...
    return Column(
      ...
      children: [
        Padding(
          ...
          child: Text(title.toUpperCase(), style: AppTextStyles.labelSmall.copyWith(color: AppColors.textDisabled, letterSpacing: 1.2)),
        ),
        Container(
          decoration: BoxDecoration(
